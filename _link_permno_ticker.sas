/*
NOTE: SIMPLY USE THE CRSP.STOCKNAMES FOR A LINK BETWEEN PERMNO AND TICKER.
      THE CODE BELOW HAS PROBLEMS WITH STOCKS WITH MULTIPLE CLASSES (MULTIPLE PERMNOS FOR A PERMCO)
